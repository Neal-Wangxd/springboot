	...
	public EmbeddedServletContainerCustomizer containerCustomizer(){
		return new EmbeddedServletContainerCustomizer(){
			...
			public void customize(ConfigurableEmbeddedServletContainer container) {
				...
				ErrorPage errorPage_405 = new ErrorPage(HttpStatus.METHOD_NOT_ALLOWED,"/error_405.html");
				ErrorPage errorPage_500 = new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR,"/error_500.html");
				container.addErrorPages(errorPage_400,errorPage_404,errorPage_405,errorPage_500);
			}
		};
	}
